...
import com.kirgor.tools.compile.CompileUtils;
import com.kirgor.tools.sql.Cursor;
import com.kirgor.tools.sql.EntityUtils;
import com.kirgor.tools.sql.Session;
import com.kirgor.tools.sql.dialect.Dialect;
import com.kirgor.tools.sql.proxy.annotation.*;
...
public abstract class StoredProcedureProxy {
    ...
    public static Class createProxyClass(Class interfaceClass, Dialect dialect) throws Exception {
        ...
        return CompileUtils.compileClass("com.kirgor.tools.sql.proxy." + name, code, classPath);
    }
    ...
    private static String buildProxyCode(String className, Class interfaceClass, Dialect dialect, List<Class> classPath) {
        ...
        result.append("package com.kirgor.tools.sql.proxy;");

        // Class header
        result.append("public class ").append(className)
                .append(" extends com.kirgor.tools.sql.proxy.StoredProcedureProxy implements ")
        ...
        for (Method method : interfaceClass.getDeclaredMethods()) {
            ...
            final String utilsClass = "com.kirgor.tools.sql.proxy.ParameterUtils.";
