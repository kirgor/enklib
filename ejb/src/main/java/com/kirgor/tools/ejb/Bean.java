...
import com.kirgor.tools.common.EncodingUtils;
import com.kirgor.tools.ejb.annotation.InjectStoredProcedureProxy;
import com.kirgor.tools.ejb.annotation.SkipSecurityCheck;
import com.kirgor.tools.ejb.exception.APIException;
import com.kirgor.tools.ejb.exception.ProxyInjectException;
...
public class Bean {
    ...
    protected SecurityTokenStorage getSecurityTokenStorage() throws Exception {
        return configBean.getConfig().getSecurityTokenStorage();
    }
        ...
        for (Field field : getClass().getDeclaredFields()) {
            if (field.getAnnotation(InjectStoredProcedureProxy.class) != null) {
                try {
                    ...
                    throw new ProxyInjectException(ex, field.getType());
                }
            }
        }
        ...
        if (httpServletRequest != null) {
            for (Cookie cookie : httpServletRequest.getCookies()) {
                if (cookie.getName().equals(configBean.getConfig().getSecurityCookieName())) {
                    ...
                    currentUserPrincipal = getSecurityTokenStorage().get(currentSecurityToken);
                }
            }
    ...
    protected Response login(Object principal, String password) throws Exception {
        ...
        if (user != null) {
            ...
            if (expectedHash.equals(actualHash)) {
                ...
                getSecurityTokenStorage().add(securityToken, principal);
    ...
    protected Response logout() throws Exception {
        getSecurityTokenStorage().remove(getCurrentSecurityToken());
        return ok();
    }
